...
BUILD_DIR=$(BUILD_BASE)/native-openssl-1.0.1e

$(NATIVEPREFIX)/lib/libssl.a: $(SOURCES_PATH)/openssl-1.0.1e.tar.gz
	tar -C $(BUILD_BASE) -xf $<; mv $(BUILD_BASE)/openssl-1.0.1e $(BUILD_DIR)
